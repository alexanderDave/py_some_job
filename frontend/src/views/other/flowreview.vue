  ...
  <div id="main_ts_page">
        测试环境流程回归：
            <div class="change_func">
                    <div id="func_square">
                        <div id="func_name">长租订单还机流程回归：</div>
                    ...
                    <!-- --------------------------------------------------------- -->
                    <div id="func_square">
                        <div id="func_name">长租订单买断流程回归:</div>
                        <input type="text" v-model="input1" :placeholder="Plcontext2"/>
                        <input type="text" v-model="input2" :placeholder="Plcontext"/>
                    ...
                    <!-- --------------------------------------------------------- -->
                    <div id="func_square">
                        <div id="func_name">小程序订单还机流程回归：</div>
                        <input type="text" v-model="input1" :placeholder="Plcontext2"/>
                        <input type="text" v-model="input2" :placeholder="Plcontext"/>
...
export default {
    ...
    data() {
        return {
          prourl:'http://localhost:8000',//后端接口的ip；
          input1:'',                        //备用参数字段
          input2:'',                        //流程回归的测试环境号
